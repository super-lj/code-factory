...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  IsTargetRepoUpdatedResponse IsTargetRepoUpdated(IsTargetRepoUpdatedRequest req)")
	fmt.Fprintln(os.Stderr, "  FetchTargetRepoLastCommitResonse FetchTargetRepoLastCommit(FetchTargetRepoLastCommitRequest req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := ci.NewCIServiceClientFactory(trans, protocolFactory)
	...
	case "IsTargetRepoUpdated":
		...
		value0 := argvalue0
		fmt.Print(client.IsTargetRepoUpdated(value0))
		fmt.Print("\n")
		break
	case "FetchTargetRepoLastCommit":
		...
		value0 := argvalue0
		fmt.Print(client.FetchTargetRepoLastCommit(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
